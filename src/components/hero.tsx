...
export function Hero() {
  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80 flex flex-col items-center">
          <p className="font-sans text-xs md:text-sm tracking-[0.4em] uppercase text-center text-white/70 mb-6">{"Architecture Studio"}</p>

          <h1
            ref={titleRef}
            className="font-serif text-6xl md:text-8xl lg:text-9xl text-balance text-center text-white mb-0 tracking-tight leading-[1]"
          >
            {"We design spaces"}
            <br />
            <span className="text-white/70 italic">{"that elevate living"}</span>
          </h1>
        </div>
      </div>
