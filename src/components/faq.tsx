    ...
    <section id="faq" className="py-20 md:py-29">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-16">
          <p className="font-sans text-muted-foreground text-xs md:text-sm tracking-[0.4em] uppercase mb-12">FAQ</p>
          <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-medium leading-[1.15] tracking-tight mb-8 text-balance">
            Questions & Answers
          </h2>
        </div>
        ...
        <div>
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-border">
              ...
              >
                <span className="font-serif text-xl md:text-2xl font-medium text-foreground transition-colors group-hover:text-foreground/70">
                  {faq.question}
                </span>
                <Plus
              ...
              >
                <p className="font-sans text-muted-foreground leading-relaxed text-sm md:text-base pb-6 pr-12">{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
